...
//        return bmp;
    ...
    private Bitmap changeBlue(Bitmap originalImage, double blue) {
        ...
        for (int x = 0; x < width; ++x) {
            for (int y = 0; y < height; ++y) {
                ...
                int r = (Color.red(com.mashazavolnyuk.effectstudio.R.color.Aqua));
                int g = (Color.green(com.mashazavolnyuk.effectstudio.R.color.Aqua));
                int b = Color.blue(com.mashazavolnyuk.effectstudio.R.color.Aqua);
    ...
    private Bitmap changeBitmapColor(Bitmap sourceBitmap, int color) {
        ...
        int blueModify = Color.blue(com.mashazavolnyuk.effectstudio.R.color.Aqua);
